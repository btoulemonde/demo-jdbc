...
//		
//		Article article1 = new Article(11, "G01", "Peinture blanche 1L", 12.5, fournisseur);
//		insertionArt.insert(article1);
//		
//		Article article2 = new Article(12, "G02", "Peinture rouge mate 1L", 15.5, fournisseur);
//		insertionArt.insert(article2);
//		
//		Article article3 = new Article(13, "G03", "Peinture noire laquée 1L", 17.8, fournisseur);
//		insertionArt.insert(article3);
//		
//		Article article4 = new Article(14, "G04", "Peinture bleue mate 1L", 15.5, fournisseur);
